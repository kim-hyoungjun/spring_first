...
public class AbstractDAO {
	...
	public Map selectPagingList(String queryId, Object params) {
		...
		if(map.containsKey("PAGE_ROW") == false || StringUtils.isEmpty((CharSequence)map.get("PAGE_ROW")) == true) {
	...
	public Object selectPagingJsonList(String queryId, Object params) {
		printQueryId(queryId);
		Map<String, Object> map = (Map<String, Object>)params;
